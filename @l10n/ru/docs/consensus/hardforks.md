...
- Новое поле в `witness_object`: `reward_percent` — доля награды за блок, делимая с голосующими (0–10000 базисных пунктов).
...
| `witness_api` | Добавить новые поля из `witness_object` в `witness_api_object` |
...
- [ ] `witness_api_object` обновлён если изменился `witness_object`
