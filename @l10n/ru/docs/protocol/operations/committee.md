...
- (HF14, медианно-голосуемые) Запрос держит не более `committee_votes_per_request` (по умолчанию 100 000) бюллетеней, а подача голоса требует `effective_vesting_shares` не менее `committee_vote_min_vesting` (по умолчанию 1000 VIZ).
