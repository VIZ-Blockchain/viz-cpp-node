...
Для интеграционных тестов загружайте плагин вместе с цепочкой и воспроизводите известную последовательность блоков с помощью `--replay-from-snapshot --snapshot-auto-latest`.
