...
namespace graphene { namespace plugins { namespace prediction_market_api {
    ...
    DEFINE_API_ARGS(list_markets_by_oracle_status, msg_pack, std::vector<fc::variant>)
    DEFINE_API_ARGS(list_markets_awaiting_resolution, msg_pack, std::vector<fc::variant>)
    DEFINE_API_ARGS(list_markets_in_dispute_window, msg_pack, std::vector<fc::variant>)
    DEFINE_API_ARGS(list_oracle_disputes,      msg_pack, std::vector<fc::variant>)
    ...
    DEFINE_API_ARGS(get_deferred_claims,        msg_pack, std::vector<pm_deferred_claim_object>)
    DEFINE_API_ARGS(get_account_commits,        msg_pack, std::vector<pm_commit_object>)
    ...
    public:
        ...
        DECLARE_API(
            ...
            (list_markets_in_dispute_window)
            (list_oracle_disputes)
