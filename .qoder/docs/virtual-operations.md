...
**Type ID:** `30`
**Trigger:** validator removed due to vote weight falling below threshold
...
Fired when a validator receives their block production reward.

### Fields

| Field | Type | Description |
|---|---|---|
| `validator` | `account_name_type` | validator account |
